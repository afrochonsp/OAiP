...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(35, 112);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(35, 219);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(156, 219);
