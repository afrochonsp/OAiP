...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(76, 38);
			...
			this->ClientSize = System::Drawing::Size(258, 79);
