...
Start:
	...
	case 2:
	{
		if (!stack) break;
		int count = 0;
		Stack *minElement = stack, *maxElement = stack, *lastPointer = stack;
		...
		Stack **tempPointer = &(lastPointer == minElement ? maxElement : minElement)->next;
		while (*tempPointer != lastPointer)
		{
			Delete(*tempPointer);
			count++;
		}
