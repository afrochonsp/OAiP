...
Start:
	...
	cout << "\n" << "Студенты с фамилией на букву А, сдавшие математику на 8 или 9\n\n";
	for (int i = 0; i < n; i++) if (students[i].name[0] == 'А' && (students[i].math == 8 || students[i].math == 9)) ShowStudentInfo(students[i], i);
	goto Start;
}
