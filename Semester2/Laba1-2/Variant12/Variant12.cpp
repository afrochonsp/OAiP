...
Start:
	...
	cout << "\n" << "Cтуденты, имеющие оценки 7 или 8 по физике и оценки 9 или 10 по высшей математике:\n\n";
	for (int i = 0; i < n; i++)
		if ((students[i].physics == 7 || students[i].physics == 8) && (students[i].math == 9 || students[i].math == 10)) ShowStudentInfo(students[i], i);
	goto Start;
}
