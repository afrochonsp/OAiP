...
Start:
	...
	cout << "\n" << "Cтуденты группы " << input << ", имеющие оценку 8 по физике и оценку 9 по высшей математике:\n\n";
	for (int i = 0; i < n; i++) if (students[i].group == input && students[i].physics == 8 && students[i].math == 9) ShowStudentInfo(students[i], i);
	goto Start;
}
