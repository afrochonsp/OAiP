...
Start:
	...
	cout << "\n" << "Cтуденты группы " << input << " c неудовлетворительной оценкой:\n\n";
	for (int i = 0; i < n; i++)
		if (students[i].group == input && (students[i].physics < 4 || students[i].math < 4 || students[i].informatics < 4 || students[i].chem < 4))
