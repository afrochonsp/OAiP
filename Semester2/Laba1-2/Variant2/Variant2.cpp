...
Start:
	...
	cin >> inputString;
	cout << "\n" << "Cтуденты-отличники на букву " << inputString << ":\n\n";
	for (int i = 0; i < n; i++)
		if (students[i].name[0] == inputString[0] && students[i].physics >= 8 && students[i].math >= 8 && students[i].informatics >= 8 && students[i].chem >= 8)
