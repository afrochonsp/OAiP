...
Start:
	...
	cout << "Cтуденты, сдавшие сессию на 8, 9 и 10:\n\n";
	for (int i = 0; i < n; i++)
		if (students[i].physics >= 8 && students[i].math >= 8 && students[i].informatics >= 8 && students[i].chem >= 8) ShowStudentInfo(students[i], i);
	goto Start;
}
