...
Start:
	...
	cout << "\n" << "Студенты, не имеющие оценку меньше 4 по информатике и математике\n\n";
	for (int i = 0; i < n; i++) if (students[i].math >= 4 && students[i].informatics >= 4) ShowStudentInfo(students[i], i);
	goto Start;
}
