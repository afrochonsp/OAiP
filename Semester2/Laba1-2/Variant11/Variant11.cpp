...
Start:
	...
	cout << "\n" << "Cтуденты группы " << input << " c оценкой 9 или 10 по информатике:\n\n";
	for (int i = 0; i < n; i++) if (students[i].group == input && (students[i].informatics == 9 || students[i].informatics == 10)) ShowStudentInfo(students[i], i);
	goto Start;
}
